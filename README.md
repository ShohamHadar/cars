...
* [שלב ג'](#שלב-ג)
    ...
    * [תרשים ERD אגף החדש - ניהול נסיעות](#תרשים-erd-אגף-החדש---ניהול-נסיעות)
    * [תרשים EDR משולב](#תרשים-edr-משולב)
    * [תרשים DSD אחרי אינטגרציה](#תרשים-dsd-אחרי-אינטגרציה)
    * [אלגוריתם הינדוס לאחור](#אלגוריתם-הינדוס-לאחור)
        * [החלטות שהתקבלו בשלב האינטגרציה](#החלטות-שהתקבלו-בשלב-האינטגרציה)
        * [תהליך שינוי שמות טבלאות](#תהליך-שינוי-שמות-טבלאות)
        * [הרחבת הסכמה לישויות חדשות](#הרחבת-הסכמה-לישויות-חדשות)
        * [הרחבת מבנה הטבלאות](#הרחבת-מבנה-הטבלאות)
        * [הגדרת אילוצי שלמות נתונים](#הגדרת-אילוצי-שלמות-נתונים)
