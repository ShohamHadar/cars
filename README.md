...
13. [שאילתות SELECT](#שלב-ב)  
14. [השוואות יעילות בין שאילתות](#השוואת-יעילות-בין-שתי-שאילתות-למציאת-נהגים-שלא-ביצעו-נסיעה-בחודש-האחרון)  

--
### אילוצים ותקינות נתונים

15. [אילוצים](#אילוצים)  
  15.1 [אילוצים בטבלת רכב](#אילוצים-בטבלת-רכב)  
  15.2 [אילוצים בטבלת נהג](#אילוצים-בטבלת-נהג)  
  15.3 [אילוצים בטבלת נסיעה](#אילוצים-בטבלת-נסיעה)  
  15.4 [אילוצים בטבלת תדלוק](#אילוצים-בטבלת-תדלוק)
  15.5 [אילוצים בטבלת תחזוקה](#אילוצים-בטבלת-תחזוקה) 
  15.6 [אילוצים בטבלת ביטוח](#אילוצים-בטבלת-ביטוח)  

---

### פעולות מתקדמות על הנתונים

16. [שאילתות DELETE ושימוש ב־ROLLBACK](#שאילתות-delete-ושימוש-בrollback-)  
17. [שימוש ב־COMMIT](#שימוש-בcommit-)  
18. [שאילתות UPDATE ושימוש ב־COMMIT](#שאילתות-update-ושימוש-בcommit-)  
## מבוא
